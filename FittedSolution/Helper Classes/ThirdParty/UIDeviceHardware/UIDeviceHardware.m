...
//    if ([deviceType isEqualToString:@"iPhone 4 (GSM)"] || [deviceType isEqualToString:@"iPhone 4 (CDMA)"] || [deviceType isEqualToString:@"iPhone 4S"] || [deviceType isEqualToString:@"iPod Touch 4G"])
//    {
//        return 3.5;
//    }
...
+(NSString *) deviceLength    // returns device's full height
{
    NSString *deviceType = [self platformString];
